...
void sphere_draw()
{
	...
	//Si se utiliza GL_TRIANGLES la esfera se ve solida
	glBindVertexArray(0);
}
...
void display(void)
{
	...
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(0.4f, 0.3f, 0.6f));
	sphere_draw();
	...
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(0.95f, 0.59f, 0.32f));
	sphere_draw();

	//tierra
	model = glm::mat4(1.0f); //Se reinicia la matriz
	model = glm::rotate(model, glm::radians(tierra), glm::vec3(0.0f, 1.0f, 0.0f));//Rotacion
	temp01 = model = glm::translate(model, glm::vec3(9, 0, 0));
	model = glm::rotate(model, glm::radians(tierra), glm::vec3(0.0f, 1.0f, 0.0f));//Rotacion
	model = glm::scale(model, glm::vec3(0.3f, 0.3f, 0.3f));
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(0.17f, 0.97f, 0.57f));
	sphere_draw();
	model = temp01;

	//Luna Tierra
	model = glm::translate(model, glm::vec3(0.5, 0, 0));
	model = glm::rotate(model, glm::radians(tierra*0.2f), glm::vec3(0.0f, 1.0f, 0.0f));//Rotacion
	model = glm::scale(model, glm::vec3(0.1f, 0.1f, 0.1f));
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(1.0f, 1.0f, 1.0f));
	sphere_draw();
	...
	temp01 = model = glm::translate(model, glm::vec3(12, 0, 0));
	model = glm::rotate(model, glm::radians(marte), glm::vec3(0.0f, 1.0f, 0.0f));//Rotacion
	model = glm::scale(model, glm::vec3(0.2f, 0.2f, 0.2f));
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(0.49f, 0.49f, 0.25f));
	sphere_draw();
	model = temp01;

	//Luna Marte 1
	model = glm::translate(model, glm::vec3(0.35, 0, 0));
	model = glm::rotate(model, glm::radians(marte*0.2f), glm::vec3(0.0f, 1.0f, 0.0f));//Rotacion
	...
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(0.77f, 0.47f, 0.14f));
	sphere_draw();
	model = temp01;
	...
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(0.99f, 0.52f, 0.0f));
	sphere_draw();
	model = temp01;
	...
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(0.9f, 0.9f, 0.0f));
	sphere_draw();

	//Urano
	model = glm::mat4(1.0f); //Se reinicia la matriz
	model = glm::rotate(model, glm::radians(urano), glm::vec3(0.0f, 1.0f, 0.0f));//Rotacion
	temp01 = model = glm::translate(model, glm::vec3(27, 0, 0));
	model = glm::rotate(model, glm::radians(urano), glm::vec3(0.0f, 1.0f, 0.0f));//Rotacion
	model = glm::scale(model, glm::vec3(1.0f, 1.0f, 1.0f));
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(0.0f, 0.58f, 0.58f));
	sphere_draw();
	model = temp01;
	...
	temp01 = model = glm::translate(model, glm::vec3(30, 0, 0));
	model = glm::rotate(model, glm::radians(pluton), glm::vec3(0.0f, 1.0f, 0.0f));//Rotacion
	model = glm::scale(model, glm::vec3(0.3f, 0.3f, 0.3f));
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(0.0f, 0.0f, 0.68f));
	sphere_draw();
	model = temp01;
