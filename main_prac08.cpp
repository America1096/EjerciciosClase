...
/*--------       W       ----     Aleja       -------------------*/
/*--------       S       ----     Acerca      -------------------*/
/*--------  Flecha der   ----  Rota derecha   -------------------*/
/*--------  Flecha izq   ---- Rota izquierda  -------------------*/
/*-----------------       2019-2      ---------------------------*/
...
{	
	...
	// set the texture wrapping parameters, como va a ser la repeticion
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_S, GL_REPEAT);
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_T, GL_REPEAT);
	// set texture filtering parameters, se pasa el parametro del filtro que va a tener 
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_LINEAR);
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
	// load image, create texture and generate mipmaps
	int width, height, nrChannels;//ancho, alto de textura, y canales que va a manejar la textura, modo de color 
	stbi_set_flip_vertically_on_load(true); // tell stb_image.h to flip loaded texture's on the y-axis. permite que se vea en ambos lados
	...
	if (data)
	{
		...
		//Si se trabaja transferencia se utiliza GL_RGBA
