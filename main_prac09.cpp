...
void LoadTextures()
{
	...
	t_tigre = generateTextures("Texturas/tigre.jpg", 0);
	t_ventana = generateTextures("Texturas/ventana.jpg", 0);
	t_ventana2 = generateTextures("Texturas/ventana2.jpg", 0);
	t_piso = generateTextures("Texturas/piso.jpg", 0);
	t_cielo = generateTextures("Texturas/cielo.jpg", 0);
	...
	glBindTexture(GL_TEXTURE_2D, t_tigre);
	glActiveTexture(GL_TEXTURE11);
	glBindTexture(GL_TEXTURE_2D, t_ventana);
	glActiveTexture(GL_TEXTURE12);
	glBindTexture(GL_TEXTURE_2D, t_ventana2);
...
void display(void)
{
	...
	lightingShader.setInt("material_diffuse", t_ventana2);
