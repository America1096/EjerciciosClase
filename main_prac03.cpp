...
void display(void)
{
	...
	// create transformations and Projection. Se inicializan como matriz identidad
	...
	//Use "view" in order to affect all models. Matriz de vista
	view = glm::translate(view, glm::vec3(movX, movY, movZ)); //Lo mueve segun los valores
